 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Oe(e,t,n=!1){const i=await q(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return Ae._forOperation(e,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve extends qe{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}Ve.type="SESSION";const $e=Ve;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wt=new T(5e3,15e3),Bt={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ut=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function qt(e){const t=e.config;b(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?E(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,o={apiKey:t.apiKey,appName:e.name,v:r.SDK_VERSION},s=Ut.get(e.config.apiHost);s&&(o.eid=s);const a=e._getFrameworks();return a.length&&(o.fw=a.join(",")),`${n}?${(0,i.querystring)(o).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;z(e,((e,i)=>{i>0&&(0,s.contains)(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),q(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Ct(e);const n=1e4+2e4*Math.random();q(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jt{static empty(){return new jt(new qt(null))}constructor(e){this.writeTree_=e}}function Ht(e,t,n){if(ke(t))return new jt(new qt(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let o=i.value;const s=Ce(r,t);return o=o.updateChild(s,n),new jt(e.writeTree_.set(r,o))}{const i=new qt(n),r=e.writeTree_.setTree(t,i);return new jt(r)}}}function Vt(e,t,n){let i=e;return z(n,((e,n)=>{i=Ht(i,we(t,e),n)})),i}function $t(e,t){if(ke(t))return jt.empty();{const n=e.writeTree_.setTree(t,new qt(null));return new jt(n)}}function Xt(e,t){return null!=Kt(e,t)}function Kt(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Ce(n.path,t)):null}function Gt(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Ye,((e,n)=>{t.push(new Me(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Me(e,n.value))})),t}function Yt(e,t){if(ke(t))return e;{const n=Kt(e,t);return new jt(null!=n?new qt(n):e.writeTree_.subtree(t))}}function Qt(e){return e.writeTree_.isEmpty()}function Jt(e,t){return Zt(me(),e.writeTree_,t)}function Zt(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?((0,s.assert)(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=Zt(we(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(we(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hn=1;class Vn{constructor(e){this.listenProvider_=e,this.syncPointTree_=new qt(null),this.pendingWriteTree_={visibleWrites:jt.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function $n(e,t,n,i,r){return function(e,t,n,i,r){(0,s.assert)(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=Ht(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?ei(e,new Lt({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Xn(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(tn(e.pendingWriteTree_,t)){let t=new qt(null);return null!=i.snap?t=t.set(me(),!0):z(i.children,(e=>{t=t.set(new pe(e),!0)})),ei(e,new St(i.path,t,n))}return[]}function Kn(e,t,n){return ei(e,new Lt({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Gn(e,t,n,i,r=!1){const o=t._path,s=e.syncPointTree_.get(o);let a=[];if(s&&("default"===t._queryIdentifier||Un(s,t))){const l=zn(s,t,n,i);0===s.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(o));const c=l.removed;if(a=l.events,!r){const n=-1!==c.findIndex((e=>e._queryParams.loadsAllData())),r=e.syncPointTree_.findOnPath(o,((e,t)=>qn(t)));if(n&&!r){const t=e.syncPointTree_.subtree(o);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&qn(t)){return[jn(t)]}{let e=[];return t&&(e=Fn(t)),z(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],r=i.query,o=ii(e,i);e.listenProvider_.startListening(ci(r),ri(e,r),o.hashFn,o.onComplete)}}}if(!r&&c.length>0&&!i)if(n){const n=null;e.listenProvider_.stopListening(ci(t),n)}else c.forEach((t=>{const n=e.queryToTagMap.get(oi(t));e.listenProvider_.stopListening(ci(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=oi(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,c)}return a}function Yn(e,t,n,i){const r=si(e,i);if(null!=r){const i=ai(r),o=i.path,s=i.queryId,a=Ce(o,t);return li(e,o,new Lt(Et(s),a,n))}return[]}function Qn(e,t,n,i=!1){const r=t._path;let o=null,a=!1;e.syncPointTree_.foreachOnPath(r,((e,t)=>{const n=Ce(e,r);o=o||Wn(t,n),a=a||qn(t)}));let l,c=e.syncPointTree_.get(r);if(c?(a=a||qn(c),o=o||Wn(c,me())):(c=new Mn,e.syncPointTree_=e.syncPointTree_.set(r,c)),null!=o)l=!0;else{l=!1,o=rt.EMPTY_NODE;e.syncPointTree_.subtree(r).foreachChild(((e,t)=>{const n=Wn(t,me());n&&(o=o.updateImmediateChild(e,n))}))}const u=Un(c,t);if(!u&&!t._queryParams.loadsAllData()){const n=oi(t);(0,s.assert)(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=Hn++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let d=On(c,t,n,en(e.pendingWriteTree_,r),o,l);if(!u&&!a&&!i){const n=Bn(c,t);d=d.concat(function(e,t,n){const i=t._path,r=ri(e,t),o=ii(e,n),a=e.listenProvider_.startListening(ci(t),r,o.hashFn,o.onComplete),l=e.syncPointTree_.subtree(i);if(r)(0,s.assert)(!qn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const t=l.fold(((e,t,n)=>{if(!ke(e)&&t&&qn(t))return[jn(t).query];{let e=[];return t&&(e=e.concat(Fn(t).map((e=>e.query)))),z(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(ci(i),ri(e,i))}}return a}
/**
 * @license
 * Copyright 2017 Google LLC
 *
