 ...
 * limitations under the License.
 */
Ft("firebase","9.15.0","app");const Gt="@firebase/database",Yt="0.14.0";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ys{trackChildChange(e){const t=e.type,n=e.childName;X("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),X(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const s=i.type;if("child_added"===t&&"child_removed"===s)this.changeMap.set(n,Xi(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===s)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===s)this.changeMap.set(n,Qi(n,i.oldSnap));else if("child_changed"===t&&"child_added"===s)this.changeMap.set(n,Ji(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==s)throw Z("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Xi(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}constructor(){this.changeMap=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xs(e,t,n,i,s){const r=new Ys;let o,a;if(n.type===ls.OVERWRITE){const c=n;c.source.fromUser?o=tr(e,t,c.path,c.snap,i,s,r):(X(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!li(c.path),o=er(e,t,c.path,c.snap,i,s,a,r))}else if(n.type===ls.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,c)=>{const l=ci(n,i);nr(t,ni(l))&&(a=tr(e,a,l,c,s,r,o))})),i.foreach(((i,c)=>{const l=ci(n,i);nr(t,ni(l))||(a=tr(e,a,l,c,s,r,o))})),a}(e,t,c.path,c.children,i,s,r):(X(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=sr(e,t,c.path,c.children,i,s,a,r))}else if(n.type===ls.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,s,r){let o;if(null!=$s(i,n))return t;{const a=new Qs(i,t,s),c=t.eventCache.getNode();let l;if(li(n)||".priority"===ni(n)){let n;if(t.serverCache.isFullyInitialized())n=Ws(i,bs(t));else{const e=t.serverCache.getNode();X(e instanceof $i,"serverChildren would be complete if leaf node"),n=Hs(i,e)}l=e.filter.updateFullNode(c,n,r)}else{const s=ni(n);let h=zs(i,s,t.serverCache);null==h&&t.serverCache.isCompleteForChild(s)&&(h=c.getImmediateChild(s)),l=null!=h?e.filter.updateChild(c,s,h,si(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(c,s,$i.EMPTY_NODE,si(n),a,r):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Ws(i,bs(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=$s(i,ti()),vs(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Jt=Dt,Pt(new ze("database",((e,{instanceIdentifier:t})=>Fo(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Ft(Gt,Yt,e),Ft(Gt,Yt,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zo(e,...t){throw Jo(e,...t)}function Ko(e,...t){return Jo(e,...t)}function Go(e,t,n){const i=Object.assign(Object.assign({},Ho()),{[t]:n});return new Ie("auth","Firebase",i).create(t,{appName:e.name})}function Yo(e,t,n){if(!(t instanceof n))throw n.name!==t.constructor.name&&zo(e,"argument-error"),Go(e,"argument-error",`Type of ${t.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Jo(e,...t){if("string"!=typeof e){const n=t[0],i=[...t.slice(1)];return i[0]&&(i[0].appName=e.name),e._errorFactory.create(n,...i)}return Bo.create(e,...t)}function Qo(e,t,...n){if(!e)throw Jo(t,...n)}function Xo(e){const t="INTERNAL ASSERTION FAILED: "+e;throw Vo(t),new Error(t)}function Zo(e,t){e||Xo(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */()}function Ya(e){const t=e.indexOf(":");return t<0?"":e.substr(0,t+1)}function Ja(e){if(!e)return null;const t=Number(e);return isNaN(t)?null:t}class Qa{toJSON(){return Xo("not implemented")}_getIdTokenResponse(e){return Xo("not implemented")}_linkToIdToken(e,t){return Xo("not implemented")}_getReauthenticationResolver(e){return Xo("not implemented")}constructor(e,t){this.providerId=e,this.signInMethod=t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jc{execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(e){this.reject(e)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:i,tenantId:s,error:r,type:o}=e;if(r)return void this.reject(r);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(a))}catch(e){this.reject(e)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Kc;case"linkViaPopup":case"linkViaRedirect":return Yc;case"reauthViaPopup":case"reauthViaRedirect":return Gc;default:zo(this.auth,"internal-error")}}resolve(e){Zo(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Zo(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}constructor(e,t,n,i,s=!1){this.auth=e,this.resolver=n,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
